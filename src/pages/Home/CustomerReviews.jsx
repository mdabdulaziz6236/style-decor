    ...
    return (
        <section className="py-10 bg-base-200/50 overflow-hidden">
            <div className="container mx-auto px-4 mb-10 text-center">
                ...
                <p className="text-base-content font-bold tracking-widest uppercase text-sm ">Testimonials</p>
            </div>
                    ...
                    {reviews.map((review, index) => {
                        ...
                        return (
                            <SwiperSlide key={review._id} className="rounded-3xl">
                                ...
                                {/* --- Colorful Card --- */}
                                <div className={`${currentColorClass} p-8 rounded-3xl h-full flex flex-col justify-between shadow-xl relative border border-white/20`}>
                                    ...
                                    <div className="flex items-center gap-4 z-10 relative">
                                        ...
                                        <div>
                                            {/* Text Color Dark for readability on pastel, or White for dark gradients */}
                                            <h4 className="font-bold text-lg text-gray-800 drop-shadow-sm">{review.customerName}</h4>
                                            <div className="flex gap-1 text-white text-sm drop-shadow-md">
                                                {[...Array(5)].map((_, i) => (
                                                    <FaStar key={i} className={i < review.rating ? "text-yellow-500" : "text-white/50"} />
                                                ))}
                                            </div>
                                        </div>
                                    </div>
